...
export const extractLeadFromEmail = (
	...
	try {
		logger.debug(
			`Extracting lead from email: subject="${subject}", from="${fromEmail}"`,
		)
		const isLead = isLeadEmail(subject, textBody, fromEmail)
		console.log('this is the response of isLead : ', isLead)
		...
		console.log('this is the extracted lead data : ', extracted)
