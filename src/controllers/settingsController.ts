...
export const updateSettings = async (
	...
	try {
		...
		if (autoReplyTemplate !== undefined)
			updateData.autoReplyTemplate = autoReplyTemplate
		if (autoReplySubject !== undefined)
...
const SAMPLE_LEADS: Record<string, Record<string, unknown>> = {
	moving: {
		...
		toAddress: '456 Oak Avenue, Manchester, M1 1AE',
		movingDate: '15 June 2026',
	...
	real_estate: {
		...
		extraFields: {
			propertyAddress: '14 Oak Lane, Bristol, BS1 2AB',
			budget: '£350,000–£400,000',
			viewingDate: 'Saturday 22 June',
			bedrooms: '3',
		},
	},
	insurance: {
